...
int main() {
    ...
    ss.writeToFile("Target_Obst_SS/vehicle_ss_Model.bdd");
    ...
    obs.writeToFile("Target_Obst_SS/vehicle_obst_Model.bdd");
    ...
    ts.writeToFile("Target_Obst_SS/vehicle_target_Model.bdd");
    ...
    controller.writeToFile("Controllers/vehicle_controller_Model.bdd");
    return 1;
}
